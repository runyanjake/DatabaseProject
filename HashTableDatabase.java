/**
  * HashTableDatabase.java 
  * @Author Jake Runyan
  * @Project DataBaseProject
  * @About The instantiation of a Database that uses a hashtable as its datatype.
...
public class HashTableDatabase<T> implements TableDatabase<T>{
	...
	/**
	  * Hashes a given key to a specific value.
	  * @param key The key specified.
	  */
